...
fn test_bloom_filter_insert_and_lookup() {
    ...
    .unwrap();
    bloom
        .insert_key(b"key1", TransactionId::from(1), LogSequenceNumber::from(1))
        .unwrap();
    bloom
        .insert_key(b"key2", TransactionId::from(1), LogSequenceNumber::from(1))
        .unwrap();
    bloom
        .insert_key(b"key3", TransactionId::from(1), LogSequenceNumber::from(1))
        .unwrap();
...
fn test_timeseries_append_and_scan() {
    ...
    .unwrap();
    table
        .append_point(b"cpu.usage", 1000, b"value1", TransactionId::from(1))
        .unwrap();
    table
        .append_point(b"cpu.usage", 2000, b"value2", TransactionId::from(1))
        .unwrap();
    table
        .append_point(b"cpu.usage", 3000, b"value3", TransactionId::from(1))
        .unwrap();
...
fn test_table_with_bloom_filter() {
    ...
    .unwrap();
    bloom
        .insert_key(b"user1", TransactionId::from(1), LogSequenceNumber::from(1))
        .unwrap();
    bloom
        .insert_key(b"user2", TransactionId::from(1), LogSequenceNumber::from(1))
        .unwrap();
    bloom
        .insert_key(b"user3", TransactionId::from(1), LogSequenceNumber::from(1))
        .unwrap();
...
fn test_property_bloom_filter_no_false_negatives() {
    ...
    for _ in 0..1000 {
        ...
        rng.fill_bytes(&mut key);
        bloom
            .insert_key(&key, TransactionId::from(1), LogSequenceNumber::from(1))
            .unwrap();
